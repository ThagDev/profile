...
export const portfolioDetails: Record<string, ProjectDetail> = {
  "e-commerce": {
    ...
    description: "A modern e-commerce platform built with Next.js and React, featuring secure payment processing with Stripe integration.",
    features: [
    ...
    technologies: ["Next.js", "React", "TypeScript", "Stripe API", "Tailwind CSS", "PostgreSQL"],
    duration: "3 months",
    client: "Tech Startup"
  },
  "task-app": {
    ...
    description: "A comprehensive task management application with real-time collaboration features powered by Firebase.",
    features: [
  ...
  photographer: {
    ...
    description: "An elegant portfolio website for a professional photographer, featuring smooth animations and optimized image galleries.",
    features: [
    ...
    technologies: ["Next.js", "Framer Motion", "Tailwind CSS", "Cloudinary", "Vercel"],
    duration: "1.5 months",
  ...
  "blog-platform": {
    ...
    description: "A modern blog platform with headless CMS integration, providing an excellent writing and reading experience.",
    features: [
  ...
  "real-estate": {
    ...
    description: "A comprehensive real estate listing platform with advanced search capabilities and property management features.",
    features: [
  ...
  "weather-app": {
    ...
    description: "An interactive weather dashboard providing detailed weather information with beautiful data visualizations.",
    features: [
    ...
    technologies: ["React", "Weather API", "Chart.js", "TypeScript", "Styled Components"],
    duration: "1 month",
